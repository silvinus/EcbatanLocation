...
namespace PlanningLocation.Web.Components.Pages;
...
public partial class Home
{
    ...
    private async Task LoadOccupation()
    {
        ...
        _occupation = await Mediator.Send(
            new PlanningLocation.Application.Queries.GetDailyOccupation.GetDailyOccupationQuery(date));
    }
    ...
    private async Task LoadRangeOccupation()
    {
        if (_rangeStart.HasValue && _rangeEnd.HasValue)
        {
            _rangeOccupation = await Mediator.Send(
                new PlanningLocation.Application.Queries.GetRangeOccupation.GetRangeOccupationQuery(
