    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PricingGrids", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcceptedBy = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    AcceptedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ConfirmedBy = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentableAlone = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    PricingGridId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ClientType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    PricePerDayPerPerson = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PricingLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PricingLines_PricingGrids_PricingGridId",
                        column: x => x.PricingGridId,
                        principalTable: "PricingGrids",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PricingGrids_Year",
                table: "PricingGrids",
                column: "Year",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PricingLines_PricingGridId",
                table: "PricingLines",
                column: "PricingGridId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_StudioId_Status",
                table: "Reservations",
